...
target_experiment_ids_tool_enabled = ['690442299376853048','128706956441954763','236190549831905507','102367565098738868','668536204546848893']
...
def extract_all_experiments_data(mlruns_path='/mlruns'):
    ...
    for experiment_id in os.listdir(mlruns_path):
        ...
        if os.path.isdir(experiment_path):
            try:
                if experiment_id in target_experiment_ids_tool_enabled:
...
with open('exp2_adaptive_params_all_data.json', 'w') as f:
